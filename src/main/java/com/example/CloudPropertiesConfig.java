...
//	String solrservice;
    ...
    public DataSource inventoryDataSource() {
	 ...
	 @Bean
	   public SolrRepository solrRepository() {
		  SolrRepositoryConnectionCreator rcc = new SolrRepositoryConnectionCreator();
		  this.cloud().registerServiceConnectorCreator(rcc);
		 return connectionFactory().service(SolrRepository.class);
	   }
